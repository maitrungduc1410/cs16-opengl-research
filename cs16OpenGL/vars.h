...
typedef struct { // cvars (of course ;P)
	...
	int	aim_hitbox;	// aimbot: 0=head 1=neck 2=chest
	int	aim_pt;		// aimbot: fine offset along head→chest (neg = lower). One value for stand+duck.
...
char	eng_hb_ok[33]	={0};	// 1 = this frame's studio draw posed head/chest
char	eng_hb_mask[33]	={0};	// bit0=head bit1=chest
